...
import org.lldProblems.parkinglot.strategy.fee.VehicleBasedFeeStrategy;
import org.lldProblems.parkinglot.vehicle.*;
...
public class ParkingLotDemo {
    public static void main(String[] args) {
        ...
        if (carTicketOpt.isPresent()) {
            Optional<Double> feeOpt = parkingLot.unparkVehicle(car.getLicenceNumber());
